...
trait SwaggerApi {
  ...
  lazy val route: Route = DebuggingDirectives.logRequestResult("swagger-logger") {pathPrefix(ProductsEndpoint.apiResource / ProductsEndpoint.apiVersion) {pathPrefix(contextPath) {
