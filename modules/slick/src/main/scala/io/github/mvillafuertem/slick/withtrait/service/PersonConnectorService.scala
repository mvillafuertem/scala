...
final class PersonConnectorService(vertexRepository: VertexRepository[Future, VertexDBO], edgeRepository: EdgeRepository[Future, EdgeDBO])
    extends PersonConnector[Future] {
