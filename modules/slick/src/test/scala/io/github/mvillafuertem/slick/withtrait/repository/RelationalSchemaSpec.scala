 ...
 */
final class RelationalSchemaSpec extends InfrastructureConfigurationSpec
  ...
  "Schema" should "print the database schema for copy & paste" in {
    ...
    val result = (relationalRepositories.vertexTable.schema ++ relationalRepositories.edgeTable.schema)
