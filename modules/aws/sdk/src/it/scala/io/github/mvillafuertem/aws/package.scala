...
package object aws {
  ...
  implicit class RichCloudWatchAsyncClientBuilder(cloudWatchAsyncClientBuilder: CloudWatchAsyncClientBuilder) {
    def add[T](value: Option[T], builder: CloudWatchAsyncClientBuilder => T => CloudWatchAsyncClientBuilder): CloudWatchAsyncClientBuilder =
      value.fold(cloudWatchAsyncClientBuilder)(builder(cloudWatchAsyncClientBuilder))
  }
