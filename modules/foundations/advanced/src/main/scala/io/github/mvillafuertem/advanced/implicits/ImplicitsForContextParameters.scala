...
object ImplicitsForContextParameters {
  ...
  /**
   * Ver la diferencia cuando los implicitos no están disponibles, pero estamos acoplando la lógica de negocio con las necesidades de ejecución. Para que esto
   * no pasa, en Dotty tenemos implicit functions types o podemos usar la Reader Monad
   */
