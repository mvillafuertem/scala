...
/**
 *  ¿Qué son las Type Classes? https://dotty.epfl.ch/docs/reference/contextual/type-classes.html
 *  ¿Qué son los Rank N Types?
 *  ¿Qué es el Context Bound? https://dotty.epfl.ch/docs/reference/contextual/context-bounds.html
 *  ¿Qué es una Context Function? https://dotty.epfl.ch/docs/reference/contextual/context-functions.html
 *  ¿Qué es Extension?
 *  ¿Qué es Infix?
 *  ¿Qué es Target Name? https://dotty.epfl.ch/docs/reference/other-new-features/targetName.html
