...
object Semigroup {
   ...
   * Scala 2 Syntax
   *
   * implicit val intSemigroup: Semigroup[Int] = new Semigroup[Int] def combine(a: Int, b: Int): Int = a + b
   */
...
//    def combine(a: String, b: String): String = a + b
   ...
   * Scala 2 Syntax
   *
   * implicit class SemigroupSyntax[T: Semigroup](a: T) { def |+|(b: T): T = Semigroup[T].combine(a, b)
   */
  extension [T: Semigroup](a: T) def |+|(b: T): T = Semigroup[T].combine(a, b)
