...
case class KafkaConfig(
  ...
  heaterinputtopic: String = "heatercontrol",
  heatersourcegroup: String = "HeaterControlGroup",
  heateroutputtopic: String = "sensor",
  heateroutputgroup: String = "sensorGroup",
  thermostattopic: String = "thermostat",
  thermostatgroup: String = "thermostatServingGroup",
  temperaturesettopic: String = "tempset",
  temperaturesetgroup: String = "tempsetGroup"
)
